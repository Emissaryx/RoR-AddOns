...
function PureTargetUnitFrame:InitializeFrameElements()
	...
	if( self.m_IsFriendly ) then
		...
		fontAlpha		= Pure.Get( "friendly-frame-font-alpha" ) 
	else
	...
	WindowSetFontAlpha( windowId .. "HitPointsStatus", fontAlpha )
	WindowSetFontAlpha( windowId .. "ActionPointsStatus", fontAlpha )
	WindowSetFontAlpha( windowId .. "HitPointsStatusBackground", fontAlpha )
	WindowSetFontAlpha( windowId .. "ActionPointsStatusBackground", fontAlpha )
