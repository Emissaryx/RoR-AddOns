...
-- Cache for ability name -> ids mapping to avoid repeated full-range scans
Enemy._abilityIdsByName = Enemy._abilityIdsByName or {}
...
function Enemy.GetAbilityIds (name)
	...
	local cache = Enemy._abilityIdsByName
	local ids = cache[name]
