...
local T = LibStub( "WAR-AceLocale-3.0" ):NewLocale( "EZCraftX", "ruRU", false, debug )

if not T then return end

--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=false, handle-subnamespaces="concat", handle-unlocalized="english")@
