...
local ACEDB_MAJOR, ACEDB_MINOR = "WAR-AceDB-3.0", 9
...
RegisterEventHandler(SystemData.Events.EXIT_GAME, "AceDBLogoutHandler")
RegisterEventHandler(SystemData.Events.LOG_OUT, "AceDBLogoutHandler")
RegisterEventHandler(SystemData.Events.QUIT, "AceDBLogoutHandler")

--REMOVED: AceDB.frame:RegisterEvent("PLAYER_LOGOUT")
--REMOVED: AceDB.frame:SetScript("OnEvent", logoutHandler)
