...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" >
    <UiMod name="SocialWindow 2.0" version="1.0.6" date="07/04/2025" >
        ...
        <Files>
            ...
            <File name="Source/SocialWindowBuddyListTabIgnore.xml" />
        ...
        <SavedVariables>
            ...
            <SavedVariable name="SocialWindowBuddyListTabIgnore.Settings" />
