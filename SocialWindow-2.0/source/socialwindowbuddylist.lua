...
local tabs = 
{
    ...
    [TAB_IGNORE] = { windowName=PARENT_WINDOW.."TabIgnore",   buttonName=PARENT_WINDOW.."ViewMode2", listId=IGNORE_MENU,
                      tooltip=StringTables.Social.TOOLTIP_SOCIAL_TAB_IGNORE,   title=StringTables.Social.LABEL_SOCIAL_TAB_IGNORE,
                      tabClass=SocialWindowBuddyListTabIgnore},
}
...
SocialWindowBuddyList.ICON_IGNORE     = 68
...
function SocialWindowBuddyList.Initialize()
    ...
    local texture, x, y = GetIconData(SocialWindowBuddyList.ICON_IGNORE)
    DynamicImageSetTexture(PARENT_WINDOW.."ViewMode2Image", texture, x, y)
...
function SocialWindowBuddyList.ShowTab( tabIndex )
    ...
    if (SelectedTab == 1) then
        ...
        WindowSetShowing(PARENT_WINDOW.."FilterMenuButton", true)
		SocialWindowBuddyList.RefreshFilterMenu()
    else
	    WindowSetShowing(PARENT_WINDOW.."FilterMenuButton", false)
		if DoesWindowExist("SocialWindowBuddyListFilterMenu") then
			WindowSetShowing("SocialWindowBuddyListFilterMenu", false)
		end
