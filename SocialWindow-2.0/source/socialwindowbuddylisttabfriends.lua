...
function SocialWindowBuddyListTabFriends.OnRButtonUpPlayerRow()
    ...
    if( SelectedFriendsName ~= L"" ) then
		...
		SocialWindowTabFriends.SelectedFriendsName = SocialWindowBuddyListTabFriends.playerListData[dataIndex].name
		local customItems = {}
        if SocialWindowBuddyListTabFriends.playerListData[dataIndex].friendType == FRIENDTYPE.FRIENDED then
		...
		PlayerMenuWindow.ShowMenu(SelectedFriendsName, 0, customItems)
    end
end
